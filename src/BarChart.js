...
const industries = {
  ...
  shoppingGoogleBing: {
    industryNames: [
      ...
      'Art & Music',
      'Chemical & Industrial'],
    backgroundColors: ['rgba(14, 116, 187, 0.4)', 'rgba(93, 170, 212, 0.4)', 'rgba(251, 137, 67, 0.4)', 'rgba(252, 189, 148, 0.4)', 'rgba(251, 192, 26, 0.4)', 'rgba(253, 214, 93, 0.4)', 'rgba(131, 211, 148, 0.4)', 'rgba(65, 178, 88, 0.4)', 'rgba(139, 211, 233, 0.4)', 'rgba(31, 175, 209, 0.4)', 'rgba(104, 107, 174, 0.4)', 'rgba(181, 185, 220, 0.4)', 'rgba(147, 73, 160, 0.4)', 'rgba(203, 131, 179, 0.4)', 'rgba(157, 22, 125, 0.4)', 'rgba(127, 128, 133, 0.4)'],
  ...
  bingSearchDisplay: {
    industryNames: [
      ...
      "Technology",
      "Travel & Hospitality"],
    backgroundColors: ["rgba(59, 117, 94, 0.4)", "rgba(106, 108, 192, 0.4)","rgba(202, 222, 45, 0.4)", "rgba(226, 112, 60, 0.4)", "rgba(192, 55, 36, 0.4)", "rgba(37, 120, 180, 0.4)", "rgba(153, 156, 167, 0.4)", "rgba(188, 71, 169, 0.4)", "rgba(44, 114, 125, 0.4)", "rgba(38, 38, 38, 0.4)", "rgba(80, 70, 87, 0.4)", "rgba(84, 168, 61, 0.4)", "rgba(227, 143, 77, 0.4)", "rgba(60, 83, 148, 0.4)", "rgba(107, 139, 177, 0.4)", "rgba(144, 210, 189, 0.4)", "rgba(213, 132, 210, 0.4)", "rgba(255, 154, 143, 0.4)"],
    borderColors: ["rgba(59, 117, 94, 1)", "rgba(106, 108, 192, 1)", "rgba(202, 222, 45, 1)", "rgba(226, 112, 60, 1)", "rgba(192, 55, 36, 1)", "rgba(37, 120, 180, 1)", "rgba(153, 156, 167, 1)", "rgba(188, 71, 169, 1)", "rgba(44, 114, 125, 1)", "rgba(38, 38, 38, 1)", "rgba(80, 70, 87, 1)", "rgba(84, 168, 61, 1)", "rgba(227, 143, 77, 1)", "rgba(60, 83, 148, 1)", "rgba(107, 139, 177, 1)", "rgba(144, 210, 189, 1)", "rgba(213, 132, 210, 1)", "rgba(255, 154, 143, 1)"]
  }
} 
